...
describe("#takeUntil", () => {
  ...
  it("returns ['I\'ve'] for ['I've', 'been', 'to', 'Hollywood', ',', 'I've', 'been', 'to', 'Redwood'] x => x === 'been'", () => {
    assert.deepEqual(takeUntil(["I've", "been", "to", "Hollywood", ",", "I've", "been", "to", "Redwood"], x => x === "been"), ["I've"]);
  });
